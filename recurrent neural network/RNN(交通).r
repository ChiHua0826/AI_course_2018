...
X  <-  as.matrix(read.csv("C:/Users/user/Desktop/x(交通).csv"))
Y  <-  as.matrix(read.csv("C:/Users/user/Desktop/y(交通).csv"))
...
model %>% 
  layer_simple_rnn(units = 1, activation = "linear", return_sequences = TRUE, 
